...
export const MODEL_CODES: ModelCode[] = [
  ...
  { maker: "Honda", label: "DJ-1",          katashiki: ["AF12"],                cc: 50,  category: "スクーター", query: "DJ-1 AF12" },
  { maker: "Honda", label: "DJ-1R",         katashiki: ["AF12"],                cc: 50,  category: "スクーター", query: "DJ-1R AF12" },
  { maker: "Honda", label: "DJ-1RR",        katashiki: ["AF19"],                cc: 50,  category: "スクーター", query: "DJ-1RR AF19" },
  { maker: "Honda", label: "ジュリオ",      katashiki: ["AF52"],                cc: 50,  category: "スクーター", query: "ジュリオ Julio AF52" },
  { maker: "Honda", label: "パル",          katashiki: ["AF17"],                cc: 50,  category: "スクーター", query: "パル PAL AF17" },
  ...
  { maker: "Yamaha", label: "ベルーガ50",   katashiki: ["3CP"],                 cc: 50,  category: "スクーター", query: "ベルーガ50 ヤマハ 3CP" },
  { maker: "Yamaha", label: "JOGポシェ",    katashiki: ["SA08J"],               cc: 50,  category: "スクーター", query: "JOGポシェ SA08J" },
  { maker: "Yamaha", label: "スーパーJOG ZR", katashiki: ["3YK"],              cc: 50,  category: "スクーター", query: "スーパーJOG ZR 3YK" },
  ...
  { maker: "Suzuki", label: "蘭",           katashiki: ["CS50"],                cc: 50,  category: "スクーター", query: "蘭 ラン スズキ CS50" },
  { maker: "Suzuki", label: "ランディー",   katashiki: ["FM50"],                cc: 50,  category: "スクーター", query: "ランディー スズキ FM50" },
  { maker: "Suzuki", label: "モレ",         katashiki: ["FA14"],                cc: 50,  category: "スクーター", query: "モレ スズキ FA14" },
  { maker: "Suzuki", label: "スワニー",     katashiki: ["SA41A"],               cc: 50,  category: "スクーター", query: "スワニー スズキ" },
